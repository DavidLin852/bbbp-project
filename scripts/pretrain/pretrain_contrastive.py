#!/usr/bin/env python
"""Pretrain GNN with Contrastive Learning (Strategy 3)"""
...
from src.pretrain.contrastive import pretrain_contrastive

def parse_args():
    parser = argparse.ArgumentParser(description="GNN: Molecular Contrastive Learning")
    ...
    parser.add_argument("--save_dir", type=str, default="artifacts/models/pretrain/contrastive")
...
def main():
    args = parse_args()
    print("=" * 60)
    print("GNN Pretraining: Molecular Contrastive Learning (Strategy 3)")
    print("=" * 60)
    ...
    history = pretrain_contrastive(
        ...
        proj_dim=args.proj_dim, num_layers=args.num_layers, heads=args.heads,
